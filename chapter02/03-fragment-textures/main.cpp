 ...
 *
 * 절차적 텍스처 패턴을 Fragment Shader에서 생성합니다.
...
class FragmentTexturesExample : public ch02::ShaderExampleBase
{
public:
    FragmentTexturesExample()
        : ShaderExampleBase("Chapter 02-03: Fragment Textures", 800, 600)
    {
...
protected:
    ...
    void renderImGui() override
    {
        ...
        if (ImGui::Combo("Type", &t, types, 4))
            pushConstants.textureType = (float)t;
