...
private:
    ...
    void initWindow()
    {
        ...
        window = glfwCreateWindow(WIDTH, HEIGHT, "Chapter 02-01: Vertex Animation", nullptr, nullptr);
    }
    ...
    void createInstance()
    {
        ...
        appInfo.pApplicationName = "Vertex Animation";
